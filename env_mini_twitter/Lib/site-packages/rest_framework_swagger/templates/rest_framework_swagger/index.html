      ...
      <div class="wrapper">
        <div class="topbar-wrapper">
          ...
          <div class="download-url-wrapper">
            ...
            <a class="download-url-button button" href="{{ LOGOUT_URL }}?next={{ request.path }}">{% trans "Logout"
              %}</a>
            {% else %}
            <a class="download-url-button button" href="{{ LOGIN_URL }}?next={{ request.path }}">{% trans "Session
              Login" %}</a>
            {% endif %}
            {% endif %}
          </div>
